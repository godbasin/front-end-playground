            ...
            '/front-end-basic/': [
                {
                    ...
                    children: [
                        ...
                        '/front-end-basic/skill/how-to-manage-front-end-project.md',
                ...
                }, 
                {
                    ...
                    collapsable: true,
                    children: [
                        '/front-end-basic/deep-learning/complex-front-end-project-solution.md',
            ...
            '/angular/': [
                {
                    ...
                    children: [
                        ...
                        '/angular/deep-into-angular/angular-design-ivy-6-detect-change.md',
                    ]
                }, {
                    title: '玩转 Angular',
                    collapsable: true,
            ...
            '/front-end-work/': [
                {
                    ...
                    children: [
                        ...
                        '/front-end-work/front-end-days/about-front-end-12.md',
                        '/front-end-work/front-end-days/about-front-end-13.md',
                        '/front-end-work/front-end-days/about-front-end-14.md',
                        '/front-end-work/front-end-days/about-front-end-15.md',
                        '/front-end-work/front-end-days/about-front-end-16.md',
                        '/front-end-work/front-end-days/about-writing.md',
                        '/front-end-work/front-end-days/about-updating.md',
                        '/front-end-work/front-end-days/a-book-with-one-story.md',
                        '/front-end-work/front-end-days/my-2021.md',
                        '/front-end-work/front-end-days/2026-programer.md',
                    ]
                }, {
                    title: '面试这件事',
                    collapsable: true,
