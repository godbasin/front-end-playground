...
要创建边界，如地板、墙壁等，即添加固定的刚体，这时候我们只需要把刚体的密度设置为 0 就可以实现。
...
[此处查看项目代码（仅包含 src 部分）](https://github.com/godbasin/box2djs-tutorial/tree/master/6-practice/6-3-add-bound/6-3-add-bound)  
